...
class SearchCompiler(Compiler):
    ...
    weight -- A limit on the maximum weight for circuits to be expanded for further searching.  See gatesets.py for more information.
    ...
    timeout -- An uper limit on the amount of time the compiler will spend trying to synthesize a circuit.
