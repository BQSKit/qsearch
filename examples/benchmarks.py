import qsearch
from qsearch import unitaries, advanced_unitaries, solvers, gatesets, leap_compiler
import warnings
...
if __name__ == "__main__":
    ...
    with qsearch.Project("benchmarks") as project:
        ...
        project['solver'] = solvers.QFactor_Solver(solvers.LeastSquares_Jac_SolverNative())
